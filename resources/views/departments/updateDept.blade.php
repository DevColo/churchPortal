 ...
 <div class="row">
            		<div class="col-md-12">
            			<div class="dt-buttons">
            				<a class="dt-button buttons-print btn dark btn-outline" style="background: #123806;" tabindex="0" aria-controls="sample_1" href="{{route('addDept')}}">
            					<span><i class="fa fa-plus"></i> Add New Department</span>
            				</a>
            			</div>
            		</div>
            	</div><br>
